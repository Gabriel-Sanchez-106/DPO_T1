...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("14. Consultar país de origen atleta (PUNTO 1) \n");
	}
	...
	/** 
	 * Ejecuta la opción requerida por el taller, busca el nombre de un atleta y retorna su país
	 */
	private void ejecutarBusquedaAtleta()
	{
		...
		try
		{
			Atleta main = calculadora.BAtleta(name);
			System.out.println("El país de origen de " + main + " es: " + main.darPais().darNombre());

		}
		catch (Exception e) 
		{
			System.out.println("El nombre ingresado no es valido. Revise el nombre de entrada");
		}
